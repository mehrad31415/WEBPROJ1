...
if (page == 'info.html') {
    ...
    const infoFooter = document.createElement('footer');
...
{//repeating elements
    ...
    if (page == 'index.html' || page == '') {
        title.append(document.createTextNode('12 ANGRY MEN | HOME'));
    } else {
...
function tooltipshow(event) {
    ...
    container.style.left = Math.min((15 + event.pageX), (window.innerWidth - container.getBoundingClientRect().width - body.getBoundingClientRect().left) - 15) + "px"; console.log(window.screenX); console.log(window.screenLeft);
