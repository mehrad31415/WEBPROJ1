...
const genre    = "courtroom drama";

const year     = "1957";

const poster   = "https://en.wikipedia.org/wiki/12_currentMovie_%281957_film%29#/media/File:12_currentMovie_(1957_film_poster).jpg";

const trailer  = "https://www.youtube.com/watch?v=TEN-2uTi2c0";

const link     = "https://en.wikipedia.org/wiki/12_currentMovie_(1957_film)"

const plot     =   'In the sweltering jury room of the New York County Courthouse, a jury prepares to deliberate the case of an impoverished teenager accused of stabbing his abusive father to death. The judge instructs the Jury that if there is any reasonable doubt, the jurors are to return a verdict of not guilty; if found guilty, the defendant will receive a mandatory death sentence via the electric chair. The verdict must be unanimous.' +
