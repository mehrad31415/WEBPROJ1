...
const poster = "https://lwlies.com/wp-content/uploads/2018/04/saving-priate-ryan.jpg";

const trailer = "https://www.youtube.com/watch?v=9CiW_DgxCnQ";

const link = "https://en.wikipedia.org/wiki/Saving_Private_Ryan";

const plot = `On June 6, 1944, the U.S. Army lands at Omaha Beach as part of the Normandy invasion, incurring major losses against the artillery and mortar fire of the entrenched German forces. Initially dazed by the chaotic battle, 2nd Ranger Battalion Captain John H. Miller takes command of a surviving group and leads a successful infiltration behind German lines to secure victory. The United States Department of War receives communication that three of four Ryan brothers have been killed in action; the last, James Francis Ryan of the 101st Airborne Division, is listed as missing. General of the Army George C. Marshall orders that Ryan be found and sent home, to spare his family the loss of all its sons. Miller is tasked with recovering Ryan and assembles a detachment of soldiers to accompany him: Mike Horvath, Richard Reiben, Adrian Caparzo, Stanley Mellish, Daniel Jackson, Irwin Wade, and interpreter Timothy Upham, who lacks any combat experience.

The group tracks Ryan to the town of Neuville-au-Plain where Caparzo is killed by a German sniper while trying to rescue a young girl. Mourning their friend, the men grow resentful at being forced to risk their lives for one man. They later find James Frederick Ryan but realize he is the wrong man with a similar name. That evening, the men rest in a chapel, where Miller tells Horvath that his hands began uncontrollably shaking after he joined the war. The men travel to a rallying point where the 101st Airborne might be after landing off course, where they find masses of wounded and displaced soldiers. Wade admonishes Reiben, Mellish, and Jackson for callously searching through a pile of recovered dog tags in front of passing troops, hoping to find Ryan's among them and conclude their mission. Remorseful for ignoring their behavior, Miller shouts for anyone that knows Ryan; one deafened soldier tells him that Ryan was reassigned to defend a vital bridge in the town of Ramelle.
