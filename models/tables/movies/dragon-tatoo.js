...
const poster = "https://m.media-amazon.com/images/M/MV5BMTczNDk4NTQ0OV5BMl5BanBnXkFtZTcwNDAxMDgxNw@@._V1_.jpg";

const trailer = "https://www.youtube.com/watch?v=DqQe3OrsMKI";

const link = "https://en.wikipedia.org/wiki/The_Girl_with_the_Dragon_Tattoo_(2011_film)";

const plot = `In Stockholm, journalist Mikael Blomkvist is recovering from the legal and professional fallout of a libel suit brought against him by businessman Hans-Erik Wennerström. The wealthy Henrik Vanger offers Blomkvist evidence against Wennerström in exchange for an unusual task: investigate the 40-year-old disappearance and presumed murder of Henrik's grandniece, 16-year-old Harriet.
